  ...
  return (
    <div className="mb-4 flex items-start justify-between gap-2">
        ...
        <div>
          ...
          {squadId && squadName && (
            <p className="mt-1.5 flex items-start gap-1.5 rounded-lg border border-amber-500/20 bg-amber-500/10 px-2 py-1.5 text-[10px] leading-snug text-amber-100/90">
              <Swords
                className="mt-0.5 size-3 shrink-0 text-amber-400/90"
                aria-hidden
              />
      ...
      <button
        ...
        className="flex size-8 shrink-0 items-center justify-center rounded-full bg-zinc-800 text-zinc-400 transition hover:bg-zinc-700 hover:text-white active:scale-90"
      >
