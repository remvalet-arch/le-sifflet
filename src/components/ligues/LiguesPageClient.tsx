    ...
    <div className="space-y-4">
                ...
                <div className="pointer-events-none relative mt-3 flex items-center gap-2 border-t border-white/5 pt-3">
                  ...
                  <div className="pointer-events-auto relative ml-auto">
                    <button
                      ...
                      className="flex size-8 items-center justify-center rounded-lg border border-white/10 bg-zinc-800/60 text-zinc-500 hover:text-zinc-300"
      ...
      <div className="rounded-2xl border border-zinc-800 bg-zinc-900/40 p-4">
        <div className="mb-1 flex items-center gap-2">
          <Swords className="size-4 text-amber-500/70" aria-hidden />
