...
>
> **Dernière mise à jour : sprint Clean-up — purge `long_term_bets` côté app, PWA `sw.js`, Realtime `alert_signals` (0047), E2E (Kop / Pronos / Bunker).**
...
*Fin du document — audit codebase au 2026-05-03 (sprint Clean-up).*
