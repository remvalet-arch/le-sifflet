-- 0046 : auto-abonnement match quand un prono est placé (Smart Notifications)
-- Insère une ligne match_subscriptions si absente (ne pas écraser smart_mute si déjà abonné).
